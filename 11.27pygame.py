...
pygame.mixer.music.load('background_music.mp3')  # 确保音乐文件在正确的路径
pygame.mixer.music.play(-1)

# 加载背景图像
background_image = pygame.image.load('background_image.jpg')  # 确保背景图文件在正确的路径

# 加载按钮图片
button_image = pygame.image.load('start_button.JPG')  # 确保图片文件在正确的路径
